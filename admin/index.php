...
<body>
    <div class="container">
        ...
        <nav style="--bs-breadcrumb-divider: url(&#34; data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width='8' height='8'><path d="M2.5 0L1 1.5 3.5 4 1 6.5 2.5 814-4-4-4z fill='currentColor'/></svg>&#34;);" aria-label="breadcrumb">
            <ol class="breadcrumb">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <a data-href="#" class="btn btn-warning btn-sm update" data-bs-toggle="modal" data-bs-target="#editdata" data-idhero="<?= $row['idhero']; ?>" data-judul="<?= $row['judul']; ?>" data-subjudul="<?= $row['subjudul']; ?>"><i class="fa fa-pen"></i></a>
